...
// New Prusa I3 Extended blue and orange
...
#define STRING_CONFIG_H_AUTHOR "(elmuchacho, prusa_extended)" // Who made the changes.
...
#define HOMING_FEEDRATE {4000, 4000, 120, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {199.86,200,4000,398.50}  // default steps per unit for Ultimaker
